...
import net.neoforged.gradle.foxlauncher.extensions.DynamicProjectManagementExtension;
...
public class FoxLauncherSettingsPlugin implements Plugin<Settings> {
...
/*                repositories.maven(mavenConfig -> {
                    mavenConfig.setUrl("https://ldtteam.jfrog.io/artifactory/neogradle-next");
                    mavenConfig.setName("NeoGradle-Next");
                });*/
                repositories.maven(mavenConfig -> {
    ...
    private static final class DynamicProjectPluginAdapter implements Action<Project> {
        ...
        public void execute(@NotNull Project project) {
            ...
            match.ifPresent(desc -> project.getPlugins().apply(FoxLauncherProjectPlugin.class));
        }
    }
}
